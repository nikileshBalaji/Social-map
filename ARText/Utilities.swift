...
func storeInUserdefault(userData: Any, withKey: String){
    let defaults = UserDefaults.standard
    defaults.set(userData, forKey: withKey)
}

func getUserData(withKey: String) -> Any {
    let defaults = UserDefaults.standard
    return defaults.object(forKey: withKey) as Any
}
